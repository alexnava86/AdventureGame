...
namespace Prime31
{
    ...
    public class CharacterController2dOld : MonoBehaviour
    {
        ...
        //ADDED BY NAVA 2/2/22 - In an effort to update input system.
        ...
        private void OnEnable()
        {
            ...
            playerBaseInputs.Character.Jump.performed += DoJump;
            playerBaseInputs.Character.Jump.Enable();
        }
        ...
        {
            movement.Disable();
            playerBaseInputs.Character.Jump.Disable();
        }
        //END ADDED BY NAVA
        #endregion
