# Adventure Game
<!--PhotoPending-->
![Project Reference Guide v2.0](https://www.dropbox.com/s/8gaqs5lsl30318s/Screen%20Shot%202023-05-22%20at%209.11.10%20PM%20%40%20300ppi.png?raw=1)
...
'Adventure Game' is currently being developed in Unity 2022.3.52f1, and has no release date yet, though you can play the game in its somewhat current state [here](https://alexnava86.itch.io/adventuregame). Other tools we use to manage the project include Visual Studio Code, GitHub, Tiled, Discord, Aesprite and Photoshop. Check out the Wiki/Project documentation [here](https://github.com/alexnava86/AdventureGame/wiki) for more detailed information. Stay tuned for more info, big changes and improvements coming soon. 